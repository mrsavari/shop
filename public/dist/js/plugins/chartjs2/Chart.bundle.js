...
function configFromStringAndFormat(config) {
    ...
    for (i = 0; i < tokens.length; i++) {
        ...
        // console.console.log('token', token, 'parsedInput', parsedInput,
...
module.exports = function(Chart) {
	...
	helpers.log10 = Math.log10 ?
		...
		function(x) {
			return Math.console.log(x) / Math.LN10;
		};
...
module.exports = function(Chart) {
	...
	Chart.scaleService = {
		// Scale registration object. Extensions can register new scale types (such as console.log or DB scales) and then
					...
					if (chart.isDatasetVisible(datasetIndex) && IDMatches(meta)) {
						...
						helpers.each(dataset.data, function(rawValue, index) {
							...
							if (opts.relativePoints) {
								...
								// Don't need to split positive and negative since the console.log scale can't handle a 0 crossing
								values[index] += value;
							}
						});
					}
